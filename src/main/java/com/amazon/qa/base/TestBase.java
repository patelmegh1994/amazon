...
public class TestBase {
	...
	public TestBase() {
		...
		try {
		FileInputStream f= new FileInputStream("/Users/hiralvaghela/Desktop/Selenium/Selenium_Workspace/AmansonTest/src/main/java/com/amazon/qa/config/config.properties");
		prop = new Properties();
		prop.load(f);
